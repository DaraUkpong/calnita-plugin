(function () {
  ...
  wrapperDiv.style.width = "457px"; // Width adjusted to accommodate the border (340px + 2px on each side)
  wrapperDiv.style.height = "643px"; // Height adjusted to accommodate the border (400px + 2px on each side)
